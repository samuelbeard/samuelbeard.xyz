        ...
        <header className="section">
            <div className="container h-20 flex items-center">
                <div className="rounded-lg border-2 flex p-1">
                    <Link href="/">
                        <a className="p-1 rounded hover:bg-red-500 mx-1 my-1">
                            <RiHomeLine className="w-6 h-6 xm-2 xbg-red-500 xtext-zinc-700" />
                        </a>
                    </Link>
                    <Link href="/">
                        <a className="p-1 rounded hover:bg-red-500 mx-1 my-1">
                            <RiMusic2Line className="w-6 h-6 xm-2 xbg-red-500 xtext-zinc-700" />
                        </a>
                    </Link>
                    <WritingLink />
                </div>
